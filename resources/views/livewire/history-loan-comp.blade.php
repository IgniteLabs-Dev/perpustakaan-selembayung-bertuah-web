<div>
    <div class="max-w-screen-xl mx-auto pt-25 flex flex-col">
        <div class="flex flex-col md:flex-row text-center md:text-start w-full justify-between mb-3">
        ...
        <div class="relative w-full overflow-x-auto p-2 md:p-0 shadow-md sm:rounded-lg">
                    ...
                    @forelse ($data as  $item)
                        <tr class="odd:bg-white even:bg-gray-100 border-b border-gray-200">
                            ...
                            <td class="px-0 py-3 text-center flex justify-center text-gray-900 font-normal ">
                                <img class="rounded-md object-cover md:h-20 md:w-auto" src="{{ asset('images/books/' . $item->book->cover) }}"
                                    alt="">
                            </td>
