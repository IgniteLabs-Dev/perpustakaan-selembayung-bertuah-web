<div>
    ...
    <div class="grid max-w-screen-xl grid-cols-2 gap-4 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-6  sm:p-8">

        <div class="flex flex-col items-center justify-center   rounded-lg shadow-sm bg-white p-4">
